...
import {
  require_jsx_runtime
} from "./chunk-AJTSD57L.js";
import {
  require_react
} from "./chunk-NTKY4DJA.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
...
var ee;
function ct() {
  return ee === void 0 && (typeof matchMedia == "function" ? ee = !!matchMedia("(pointer:coarse)").matches : ee = false), ee;
}
function ft(e) {
...
function mt(e) {
  const t = getComputedStyle(_e2(e) ?? e).display;
...
function ve(e) {
  ...
  n.forEach((a) => {
    o.add(a.group), a.panels.forEach((f) => {
      i.add(f);
    }), a.separator && (s.add(a.separator), r || (r = true, a.separator.element.focus()));
...
function St({
  ...
  switch (n) {
    case "active": {
      const s = (e & De) !== 0, l = (e & Te) !== 0, r = (e & Oe) !== 0, a = (e & Ne) !== 0;
      if (e) {
        if (s)
...
function $e({
  ...
  n.forEach((a) => {
    ...
    const d = o.get(u), {
      ...
      layout: v,
      separatorToPanels: x
    } = i.get(u) ?? { defaultLayoutDeferred: false };
    if (g && d && v && x) {
      const S = Z({
        delta: c,
        initialLayout: d,
...
var A = typeof window < "u" ? import_react.useLayoutEffect : import_react.useEffect;
function le(e) {
...
var je = (0, import_react.createContext)(null);
function Pt(e, t) {
  const n = (0, import_react.useRef)({
    getLayout: () => ({}),
    setLayout: lt
  });
  (0, import_react.useImperativeHandle)(t, () => n.current, []), A(() => {
    Object.assign(
      n.current,
      ke({ groupId: e })
    );
...
function Rt({
  ...
  const m = (0, import_react.useRef)({}), h = le((L) => {
    W(m.current, L) || (m.current = L, a == null ? void 0 : a(L));
  }), c = ae(r), d = (0, import_react.useRef)(null), [y, g] = (0, import_react.useState)(false), [v, x] = (0, import_react.useState)(n ?? {}), [S, b] = wt(), w = (0, import_react.useRef)({
  ...
  A(() => {
    ...
    if (fe) {
      ...
      !F && V.length > 0 && (x(J), h == null ? void 0 : h(J));
    }
    const Be = O.addListener(
  ...
  return (0, import_jsx_runtime.jsx)(je.Provider, { value: U, children: (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...p,
      "aria-orientation": u,
...
function At({
  ...
  const i = t !== void 0, s = "id" in o ? o.id : o.groupId, l = oe(s, t ?? []), r = (0, import_react.useSyncExternalStore)(
    Mt,
    () => n.getItem(l),
    () => n.getItem(l)
...
function ce() {
  const e = (0, import_react.useContext)(je);
  return z(
    e,
...
function It(e, t) {
  ...
  (0, import_react.useImperativeHandle)(t, () => o.current, []), A(() => {
    Object.assign(
      o.current,
...
function kt({
  ...
  const h = !!l, c = ae(l), d = (0, import_react.useRef)(null), y = ue(d, s), { id: g, registerPanel: v } = ce(), x = u !== null, S = le(
    (w, C, U) => {
      u == null ? void 0 : u(w, l, U);
    }
  );
  A(() => {
    const w = d.current;
...
function Tt({
  ...
  const l = ae(o), [r, a] = (0, import_react.useState)({}), [u, f] = (0, import_react.useState)("inactive"), p = (0, import_react.useRef)(null), m = ue(p, n), {
    id: h,
    orientation: c,
    registerSeparator: d
  ...
  }, [h, l, d]), (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...s,
